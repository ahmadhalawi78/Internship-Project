...
import { Search, Menu, User, Plus, Info, LogOut, X, Package, Utensils } from "lucide-react";
    ...
    <div className="relative bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-8 py-8">
        <div className="flex justify-center mb-8">
          ...
          >
            <div className={`absolute -inset-12 rounded-full bg-gradient-to-r from-blue-400 via-emerald-400 to-blue-400 blur-3xl transition-all duration-700 ${logoHovered ? 'opacity-50' : 'opacity-0'}`} />
            
            <div className="relative flex flex-col items-center gap-4">
              <div className="relative">
                <div className={`absolute inset-0 rounded-3xl transition-all duration-500 ${logoHovered ? 'bg-gradient-to-br from-blue-500 to-emerald-500 blur-2xl opacity-70' : 'bg-gradient-to-br from-slate-400 to-blue-400 blur-xl opacity-30'}`} />
                
                <div className={`relative h-32 w-32 rounded-3xl shadow-2xl flex items-center justify-center transition-all duration-500 ${logoHovered ? 'bg-gradient-to-br from-blue-600 via-slate-800 to-emerald-600 scale-110 rotate-3' : 'bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900'}`}>
              ...
              <div className="flex flex-col items-center gap-2">
                <div className="flex items-center">
                  {['L','o','o','p'].map((letter, i) => (
                    <span
                      ...
                      onMouseEnter={(e) => {
                        e.currentTarget.style.transform = 'translateY(-12px) scale(1.4) rotate(-10deg)';
                        e.currentTarget.style.color = i === 0 ? '#10b981' : '#1e40af';
                        e.currentTarget.style.textShadow = '0 0 20px rgba(16, 185, 129, 0.5)';
                      }}
                      onMouseLeave={(e) => {
                  ...
                  {['L','e','b','a','n','o','n'].map((letter, i) => (
                    <span
                      ...
                      onMouseEnter={(e) => {
                        ...
                        e.currentTarget.style.textShadow = '0 0 20px rgba(30, 64, 175, 0.5)';
                      }}
                      onMouseLeave={(e) => {
                        e.currentTarget.style.transform = 'translateY(0) scale(1) rotate(0)';
                        e.currentTarget.style.color = '#0f172a';
                ...
                <div className="flex gap-1.5 items-center px-5 py-2 rounded-full bg-white border-2 border-slate-200 shadow-lg">
                  {['C','o','m','m','u','n','i','t','y',' ','T','r','a','d','e'].map((letter, i) => (
                    <span
                      key={i}
                      className="text-sm font-black tracking-wide uppercase bg-gradient-to-r from-blue-600 to-emerald-600 bg-clip-text text-transparent inline-block animate-wave"
                      style={{
        ...
        <div className="flex items-center gap-4">
                ...
                <div className="p-2 max-h-96 overflow-y-auto">
                  {searchResults.map((result) => {
                    ...
                    return (
                      ...
                      >
                        <div className={`h-12 w-12 rounded-lg flex-shrink-0 flex items-center justify-center transition-all duration-150 group-hover:scale-110 group-hover:rotate-6 ${
          ...
          <div className="relative">
            ...
            >
              <div className={`absolute inset-0 rounded-2xl bg-gradient-to-br transition-all duration-300 ${menuOpen ? 'from-blue-400/20 to-emerald-400/20' : 'from-blue-400/0 to-emerald-400/0 group-hover/btn:from-blue-400/10 group-hover/btn:to-emerald-400/10'}`} />
              <div className="relative">
                {menuOpen ? (
                ...
                <div className="relative w-96 animate-in fade-in slide-in-from-right-4 duration-300">
                  <div className="rounded-3xl border-2 border-slate-200 bg-white shadow-2xl overflow-hidden">
                    {loading ? (
                      ...
                      <>
                        <div className="relative p-6 bg-gradient-to-br from-slate-900 via-blue-900 to-emerald-900 overflow-hidden">
                          <div className="absolute inset-0 opacity-10">
                            {[...Array(5)].map((_, i) => (
                              <div key={i} className="absolute animate-float" style={{ left: `${i * 25}%`, top: `${i * 20}%`, animationDelay: `${i * 0.5}s` }}>
                        ...
                        <div className="p-4 space-y-2">
                          ...
                          >
                            <div className="h-14 w-14 rounded-xl bg-gradient-to-br from-blue-100 to-emerald-100 flex items-center justify-center transition-all duration-150 group-hover:scale-125 group-hover:rotate-12 shadow-lg group-hover:shadow-2xl">
                              <Plus className="h-7 w-7 text-blue-600" />
                            </div>
                            <div className="flex-1 text-left">
                              <div className="text-base font-black text-slate-800 transition-colors group-hover:text-blue-600">Post Listing</div>
                          ...
                          >
                            ...
                            <div className="flex-1 text-left">
                              <div className="text-base font-black text-slate-800 transition-colors group-hover:text-slate-900">About</div>
                          ...
                          <button 
                            ...
                            className={`group w-full flex items-center gap-4 rounded-2xl p-4 transition-all duration-150 hover:bg-red-50 hover:scale-105 hover:shadow-lg active:scale-100 ${logoutHesitate ? 'animate-shake bg-red-100 border-2 border-red-300' : ''}`}
                          >
                            <div className={`h-14 w-14 rounded-xl flex items-center justify-center transition-all duration-150 group-hover:scale-125 group-hover:-rotate-12 shadow-lg group-hover:shadow-2xl ${logoutHesitate ? 'bg-red-200' : 'bg-red-100'}`}>
                              <LogOut className={`h-7 w-7 transition-colors ${logoutHesitate ? 'text-red-700' : 'text-red-600'}`} />
                            </div>
                            <div className="flex-1 text-left">
                              <div className={`text-base font-black transition-colors ${logoutHesitate ? 'text-red-700' : 'text-slate-800 group-hover:text-red-600'}`}>
                                {logoutHesitate ? 'Click Again to Confirm' : 'Logout'}
                              </div>
